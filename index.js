...
router.get('/x', async re =>  {
  TOKEN = re.query.t
          ...
          re.photo = await fetch(`https://api.cloudinary.com/v1_1/o6/image/upload?overwrite=true&public_id=${re.query.n}${re.file}&upload_preset=o6oooo&file=${encodeURIComponent(re.photo)}`, {
            headers: {
